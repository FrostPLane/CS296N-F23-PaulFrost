...
namespace ThurstonBoardGameClub.Data  
{
    public class SeedUsers
    {
        ...
        public static async Task CreateUsers(IServiceProvider provider)
        {
            ...
            await CreateUser("Paul", "Frost", SECRET_PASSWORD, MEMBER);
            await CreateUser("Firstname", "Lastname", SECRET_PASSWORD, MEMBER);
            await CreateUser("Guy", "Person", SECRET_PASSWORD, MEMBER);
        }
